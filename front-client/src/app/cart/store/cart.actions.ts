...
export const fetchCart = createAsyncThunk<CartDto>(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const { data } = await $api.get<any, AxiosResponse<CartDto, any>, any>(
        "/cart"
      );
      return data;
    } catch (e: any) {
...
export const addCartItem = createAsyncThunk<CartDto, CartItemDto>(
  ...
  async (item: CartItemDto, { rejectWithValue }) => {
    try {
      const { data } = await $api.post<any, AxiosResponse<CartDto, any>, any>(
        "/cart",
        item
      );
      return data;
...
export const updateCartItem = createAsyncThunk<CartDto, CartItemDto>(
  ...
  async (item: CartItemDto, { rejectWithValue }) => {
    try {
      const { data } = await $api.put<any, AxiosResponse<CartDto, any>, any>(
        "/cart",
        item
      );
      return data;
...
export const clearCart = createAsyncThunk<CartDto>(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const { data } = await $api.delete<any, AxiosResponse<CartDto, any>, any>(
        "/cart"
      );
      return data;
    } catch (e: any) {
