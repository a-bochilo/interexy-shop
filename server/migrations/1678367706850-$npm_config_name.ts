...
const getProductsColumnFromCartItem = () => new TableColumn({
    name: "product_id",
    type: "uuid",
})

const getProductsFKFromCartItem = () => new TableForeignKey({
...
const getProductsDetailsFKFromProducts = () => new TableForeignKey({
...
const getProductsTable = () => new Table({
    name: "products",
    columns: [
        {
            name: 'id',
...
const getProductsDetailsTable = () => new Table({
